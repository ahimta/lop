...
- [AWS Docs (excellent tutorials)](https://docs.aws.amazon.com)
- [DelftStack (excellent tutorials & howtos)](https://delftstack.com)
...
- [IBM z/OS Library Functions (POSIX functions not typically other manpages)](https://ibm.com/docs/en/zos/2.5.0?topic=reference-library-functions)
- [JEPSEN (excellent distributed systems resource/references)](https://jepsen.io)
...
- [microservices.io (excellent distributed systems resource/references)](https://microservices.io)
- [Premier League - Results Page (can easily be used to convert to our format)](https://premierleague.com/results)
- [Programming Rust: Fast, Safe Systems Development, 2nd Edition](https://amazon.com/dp/B0979PWD4Z)
- [regular expressions 101 (excellent for working with RegExps)](https://regex101.com)
- [Rust by Example](https://doc.rust-lang.org/rust-by-example)
- [Rust Official Formatter](https://github.com/rust-lang/rustfmt)
- [SEI CERT Coding Standards](https://wiki.sei.cmu.edu/confluence/display/seccode/SEI+CERT+Coding+Standards)
- [The Linux Programming Interface Books (excellent Linux/POSIX resource)](https://man7.org/tlpi)
...
- [TLDR pages (summarized manpages focused on examples)](https://tldr.inbrowser.app)

## Academic Resources

- [Algorithms Course Homepage](https://algs4.cs.princeton.edu)
...
- [Algorithms Course on Coursera - Part 1](https://www.coursera.org/learn/algorithms-part1)
- [Algorithms Course on Coursera - Part 2](https://www.coursera.org/learn/algorithms-part2)
